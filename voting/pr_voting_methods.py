...
def ranked_pairs_rvt(profile):
    '''Ranked pairs (see the ranked_pairs docstring for an explanation) where a random voter is 
    chosen to break any ties in the margins. 
    Since voters have strict preferences, this always returns a trivial lottery over the candidates.
    '''
